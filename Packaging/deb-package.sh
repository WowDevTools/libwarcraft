...
LIBWARCRAFT_VERSIONED_NAME="libwarcraft-$LIBWARCRAFT_MAJOR_VERSION.$LIBWARCRAFT_MINOR_VERSION"
LIBWARCRAFT_DEBUILD_ROOT=$LIBWARCRAFT_VERSIONED_NAME
...
ORIG_TAR="$LIBWARCRAFT_VERSIONED_NAME.orig.tar.xz"
if [ ! -f "$ORIG_TAR" ]; then
	tar -cJf "$ORIG_TAR" "$LIBWARCRAFT_DEBUILD_ROOT/libwarcraft/"
fi
