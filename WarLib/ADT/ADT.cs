    ...
    namespace ADT
    {
        ...
        public class ADT
        {
            ...
            public ADT(string filePath)
            {
                ...
                if (filePath.EndsWith(".adt"))
                {
                    ...
                    while (br.BaseStream.Position < ADTSize)
                    {
                        ...
                        switch (Encoding.ASCII.GetString(chunkRecognitionBuffer))
                        {
                            case "MVER":
                                {
                                    ...
                                    log.Info("Found MVER Chunk, parsing...");
                            ...
                            case "MHDR":
                                {                                    
                                    log.Info("Found MHDR Chunk, parsing...");
                            ...
                            case "MCIN":
                                {
                                    log.Info("Found MCIN Chunk, parsing...");
                            ...
                            case "MTEX":
                                {
                                    log.Info("Found MTEX Chunk, parsing...");
                            ...
                            case "MMDX":
                                {
                                    log.Info("Found MMDX Chunk, parsing...");
                            ...
                            case "MMID":
                                {
                                    log.Info("Found MMID Chunk, parsing...");
                            ...
                            case "MWMO":
                                {
                                    log.Info("Found MWMO Chunk, parsing...");
                            ...
                            case "MWID":
                                {
                                    log.Info("Found MWID Chunk, parsing...");
                            ...
                            case "MDDF":
                                {
                                    log.Info("Found MDDF Chunk, parsing...");
                            ...
                            case "MODF":
                                {
                                    log.Info("Found MODF Chunk, parsing...");
                            ...
                            case "MCNK":
                                {
                                    ...
                                    log.Info("Found MCNK Chunk, parsing. " + count);
                            ...
                            case "MFBO":
                                {
                                    log.Info("Found MFBO Chunk, parsing...");
                                    Console.WriteLine("Found MFBO Chunk, parsing...");
                                    continue;
                                }
                            case "MTXF":
                                {
                                    log.Info("Found MTXF Chunk, parsing...");
                ...
                log.Info(String.Format("Finished loading ADT with version {0}.", this.ADTVersion.version.ToString()));
                ...
                public MTEX(string adtFile, int position)
                {
                    ...
                    while (br.BaseStream.Position <= position + this.size + 4)
                    {
                        ...
                        else
                        {
                            ...
                            log.Debug("Added texture string " + str);
                    ...
                    {                        
                        ...
                        for (int i = 0; i < currentLayers.Length; i++)
                        {
                            ...
                            if (!currentLayer.flags.HasFlag(MCLY.MCLYFlags.UseAlpha))
                            {
                                ...
                                //debug
                                log.Debug("MCNK at " + x.ToString() + "," + y.ToString() + " :" + GetTextureByID(textureID));
            ...
            public string GetTextureByID(int ID)
            {
                ...
                {
                    log.Error("Got invalid texture ID. ID was: " + ID.ToString() + " and count was " + this.ADTTextures.fileNames.Count.ToString());
                    this.ADTTextures.fileNames.ForEach(log.Debug);
                    return null;
                }                
            }
